...
from app.dashapps.dash_app_2.layout import layout
from app.dashapps.dash_app_2.callbacks import register_callbacks

APP_ID = current_app.config['DASH_APP_2_URL']
...
def add_dash(server, login_reg=True):
    ...
    #app.layout = html.Div("Placeholder for "+current_app.config['DASH_APP_2_MENU_TEXT'])
    app.layout = layout
