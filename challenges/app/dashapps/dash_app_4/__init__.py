...
from app.dashapps.dash_app_4.layout import layout
from app.dashapps.dash_app_4.callbacks import register_callbacks

APP_ID = current_app.config['DASH_APP_4_URL']
...
def add_dash(server, login_reg=True):
    ...
    #app.layout = html.Div("Placeholder for "+current_app.config['DASH_APP_4_MENU_TEXT'])
    app.layout = layout
